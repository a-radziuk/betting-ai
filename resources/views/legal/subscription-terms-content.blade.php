...
<h2>{{ __('3. Eligibility') }}</h2>
<p>{{ __('You must be of legal age to use betting services in your jurisdiction and comply with all applicable laws. By subscribing, you confirm that you meet these requirements.') }}</p>

<h2>{{ __('4. Payments and access') }}</h2>
<p>{{ __('Fees are charged for the selected plan period. Access begins after successful payment and ends when the subscription period expires unless renewed.') }}</p>
