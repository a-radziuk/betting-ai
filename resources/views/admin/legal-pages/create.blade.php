...
@section('content')
    <section class="card card-pad">
        <h1 class="admin-page-title">{{ __('New legal page') }}</h1>
        ...
        <form method="post" action="{{ route('admin.legal-pages.store') }}" class="admin-upload-form">
            @csrf
            @include('admin.legal-pages._form')
