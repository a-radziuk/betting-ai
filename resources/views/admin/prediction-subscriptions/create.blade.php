...
@section('content')
    <section class="card card-pad">
        <h1 class="admin-page-title">{{ __('New prediction subscription') }}</h1>
        ...
        <form method="post" action="{{ route('admin.prediction-subscriptions.store') }}" class="admin-upload-form">
            @csrf
            @include('admin.prediction-subscriptions._form')
